...
This was a very simple and highly over simplified intuition behind the variational autoencoders (VAEs). We will now discuss the theory of the VAEs along with the implementation aspects.
